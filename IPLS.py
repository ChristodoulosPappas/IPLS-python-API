...
Path = "1.0.0.2/p2p/sad"
fileName = "myfile"
boot_list = ["12D3KooWCyJZJphf9z1Dbd2sJKYc11PVV2RBVA9HQjNz26oMANgR","12D3KooWCyJZJphf9z1Dbd2sJKYc11PVV2RBVA9HQjNz26dMANgs"]
model_size = 2


ipls.init(Path,fileName,boot_list,model_size,False);

for i in range(3):
	print("Update model")
	ipls.UpdateModel(arr)
	print("GetPartitions")
...
sockfd = socket.socket(socket.AF_INET,socket.SOCK_STREAM)
sockfd.connect(addr)
sockfd.sendall(struct.pack('!dd',*arr));
